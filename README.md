# QRAP-Node вЂ” Quantum-Resistant Autonomous Protocol
...
- **qrap-fpga** вЂ” Mock / Versal / AWS-F1 provers, TMR, radiation scrubber
- **qrap-consensus** вЂ” Orbital BFT, leader rotation, view change
- **qrap-storage** вЂ” Sparse Merkle Tree, sled persistence
- **qrap-net** вЂ” P2P message serialization, NodeId, codec
- **qrap-utxo** вЂ” UTXO commitments, spend verification
- **qrap-sim** вЂ” Byzantine, partition, FPGA degradation, DA failure
- **qrap-stark** вЂ” STARK spend proof + PLONK prover with AWS F1
- **qrap-node** вЂ” E2E integration, CLI
...
# Test (mock mode вЂ” no FPGA required)
...
| Platform | Chip | PLONK Proof | Power | Status |
|----------|------|-------------|-------|--------|
| **AWS F1** | Xilinx VU9P | 5-10s (hw_emu) | 25-67W | Kernels: field, NTT, MSM |
| **Sentinel Space** | AMD Versal XQRVC1902 | 1.6s (Full) / 4.0s (Eco) | 25-67W | XiISEM scrubber, TMR |
